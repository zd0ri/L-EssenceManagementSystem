...
// find customer_id for current user
...
try {
    ...
    if ($paymentMethod !== 'Cash on Delivery' && $paymentMethod !== '') {
        ...
        // update payments table to indicate refund -- simple mark, real integrations would call gateway
